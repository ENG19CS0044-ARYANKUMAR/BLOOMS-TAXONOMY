...
class LoginPage(Frame):
    def __init__(self, parent, controller):
        ...
        titleLabel = Label(self, text="QN Paper Classification System", pady=50, padx=150, font=LARGEFONT, background = '#faf3f3',foreground='#136335')
        ...
        def submit(event):
            ...
            if status == True:
                ...
                if (filePath == ''):
                    ...
                    tkinter.messagebox.showwarning(title="Wrong Input", message="Please select choice of Mark Distribution", )
                elif(kChoice == ''):
                    tkinter.messagebox.showwarning(title="Wrong Input", message="Please select choice of K Level", )
                elif(filePath == ''):
                    tkinter.messagebox.showwarning(title="Wrong Input", message="Please upload a file", )
